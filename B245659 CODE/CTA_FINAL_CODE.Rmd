...
```{r}
##Exploring Temporal Trends in Female-Related Vocabulary in Texts with Emotive Rhetoric Scores less than 0
...
```{r}
## Match female-related word frequency in texts which have emotive rhetoric scores less than 0 and the gender of speakers
